...
class FileSystemProvider {
    ...
    async getChildren(element) {
        ...
        const workspaceFolder = vscode.workspace.workspaceFolders?.filter(folder => folder.name === 'Documentation').filter(folder => folder.uri.scheme === 'file')[0];
        if (workspaceFolder) {
...
class FileExplorer {
    constructor(context, view) {
        ...
        context.subscriptions.push(vscode.window.createTreeView(view, { treeDataProvider }));
